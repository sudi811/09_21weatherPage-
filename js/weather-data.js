...
const WEATHER_LAYERS = {
  radar: {
    ...
    colors: ['#0000ff', '#00ffff', '#00ff00', '#ffff00', '#ff7700', '#ff0000'],
    overlayGradient: 'radial-gradient(ellipse at 52% 48%, rgba(0, 255, 255, 0.28) 0%, rgba(0, 255, 0, 0.22) 30%, rgba(255, 255, 0, 0.18) 55%, transparent 75%)'
  },
  temp: {
    id: 'temp',
    name: '溫度',
    unit: '°C',
    stops: [16, 20, 24, 28, 32, 36],
    colors: ['#3b4cc0', '#88b5ea', '#c8e2bf', '#edd292', '#e58257', '#b40426'],
    overlayGradient: 'linear-gradient(135deg, rgba(136, 181, 234, 0.25) 10%, rgba(237, 210, 146, 0.25) 50%, rgba(229, 130, 87, 0.28) 85%)'
  },
  wind: {
    id: 'wind',
    name: '風速',
    ...
    unitAlt: 'kt',
    stops: [1, 3, 5, 8, 11, 14],
    colors: ['#4b72b0', '#56b194', '#99c355', '#d4bf3b', '#d38332', '#c93f41'],
    overlayGradient: 'linear-gradient(135deg, rgba(86, 177, 148, 0.25) 15%, rgba(212, 191, 59, 0.25) 55%, rgba(201, 63, 65, 0.28) 85%)'
  },
  accumRain: {
    id: 'accumRain',
    name: '累積雨量',
    unit: 'mm',
    stops: [0.5, 5, 15, 30, 60, 100],
    colors: ['#fed976', '#feb24c', '#fd8d3c', '#fc4e2a', '#e31a1c', '#800026'],
    overlayGradient: 'radial-gradient(circle at 55% 42%, rgba(254, 217, 118, 0.28) 0%, rgba(253, 141, 60, 0.25) 40%, rgba(227, 26, 28, 0.2) 70%, transparent 85%)'
  }
};
...
function getBeaufortScale(speedMs) {
  ...
  if (speedMs < 3.4) return { scale: 2, level: '輕風', desc: '臉上微動，樹葉微動', color: '#34A853' };
  ...
  return { scale: 7, level: '疾風以上', desc: '全樹搖動，前進阻力', color: '#B31412' };
}

/**
 * 全臺 22 縣市代表性測站（真實比例地圖座標 mapX%, mapY%）
 */
